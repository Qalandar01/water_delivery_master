...
public interface CourierRepository extends JpaRepository<Courier, Long> {
    ...
    @Query(value = "SELECT DISTINCT c.* " + "FROM courier c " + "INNER JOIN orders o ON c.id = o.courier_id " + "INNER JOIN delivery_time dt ON o.delivery_time_id = dt.id " + "WHERE dt.day = :today " + "AND c.is_active = true", nativeQuery = true)
